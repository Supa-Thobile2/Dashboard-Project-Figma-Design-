...
function Gant() {
  return (
    <div className="w-[90%] mx-auto p-2 space-y-4 md:space-y-2 ">
      <div className="w-[100%]  mx-auto p-4 md:p-2  space-y-4 md:space-y-1">
        {/* filter section */}
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex gap-2 ">
              ...
              <div className="w-[100%] ">
                ...
                <p className="text-sm text-regular text-[#64748B]">
                  Add Details
                </p>
              </div>
            </div>
            <div className="  border-[1px] rounded-[12px] border-[#E2E8F0]">
              <button className="flex  items-center justify-center gap-[8px] p-2 text-lg">
                <FaRegShareSquare />
                Share
              </button>
            </div>
      ...
      <div className="w-[100%] space-y-4 border mx-auto p-4 md:flex justify-center items-center gap-4">
